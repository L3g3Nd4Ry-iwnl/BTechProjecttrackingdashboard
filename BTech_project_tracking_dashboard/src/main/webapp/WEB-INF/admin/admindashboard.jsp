...
<body class="dashboard-body">
    ...
    <main class="dashboard-main">
        <div class="intro">
            <h2>Never Underestimate the Power of Administration!</h2>
        </div>
		<%
        ...
        <div class="user-image">
            <img height="200px" width="200px" src="../images/admin.png">
        </div>
            ...
            <div class="icons">
                <div class="icon-redirect">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"
                        class="m-2 bi bi-file-earmark-person-fill" viewBox="0 0 16 16">
                        <path
                    ...
                    <form action="../admin/setup/faculty" method="GET">
                        <button>Setup new faculty account</button>
                    </form>
                </div>
                <div class="icon-redirect">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"
                    ...
                    <form action="../admin/setup/panel" method="GET">
                ...
                <div class="icon-redirect">
                    ...
                    <form action="../admin/setup/student" method="GET">
                        <button>Setup new student account</button>
                    </form>
                </div>
                <div class="icon-redirect">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"
                    ...
                    <form action="../admin/setup/project" method="GET">
