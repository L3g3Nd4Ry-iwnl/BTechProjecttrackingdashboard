...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@500&family=Oxygen:wght@300&display=swap" rel="stylesheet">
...
<body class="login-body">
    ...
    <main class="login-form">
        ...
        <div class="form-details">
            <h1>Welcome Back</h1>
            <form class="login-form-class" action="../student/login" method="POST">
                <div>
